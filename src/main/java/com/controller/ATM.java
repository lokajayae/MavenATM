   ...
   private void performTransactionsCustomer() {
      ...
      while (!userExited) {
         ...
         switch (mainMenuSelection) {
            ...
            case BALANCE_INQUIRY: // user chose to com.view balance        
